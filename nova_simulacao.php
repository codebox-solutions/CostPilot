        ...
        <div class="mt-3">
            <form class="simform">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" step="0.01" id="custo_fixo" class="form-control" name="custofixo" required value="10000.00" />
                </div>

                <div class="form-group">
                    <label for="custo_variavel">Custo Variável Unitário (R$):</label>
                    <input type="number" min="0" step="0.01" id="custo_variavel" class="form-control" name="custovariavel" required value="50.00" />
                </div>

                <div class="form-group">
                    <label for="volume">Volume Produzido/Vendido:</label>
                    <input type="number" min="1" step="1" id="volume" class="form-control" name="volume" required value="1" />
                </div>

                <div class="form-group">
                    <label for="margem_lucro">Margem de Lucro Desejada (%):</label>
                    <input type="number" min="0" step="0.01" id="margem_lucro" class="form-control" name="margemlucro" required value="20.00" />
                </div>

                <div class="form-group">
                    <label for="impostos">Impostos (Opcional, %):</label>
                    <input type="number" min="0" step="0.01" id="impostos" class="form-control" name="impostos" value="15.00" />
                </div>
                ...
                <div class="acordiao">
                    <div class="conteudo">
                        <div class="form-check mb-3">
                            <input type="checkbox" id="juros_compostos" class="form-check-input" name="juroscompostos" checked />
